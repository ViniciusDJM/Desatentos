...
var msg_queue: Array = ["Você chegou ao nivel 4!", "Agora já pode trabalhar com as informações coletadas", 
...
,"Crianças com TDAH do tipo hiperativo costumam apresentar agitação em tarefas que exigam muito foco como leitura",]
